                            ...
                            <div class="ml-4 flex flex-1 flex-col">
                              <div>
                                ...
                                >
                                  ...
                                  <p class="ml-4">${{ product.totalPrice }}</p>
                                </div>
...
const removeProduct = (productId) => {
  store.dispatch("cart/removeProduct", productId);
  cart.value = store.getters["cart/getCart"];
  totalCartPrice.value = store.getters["cart/totalCartPrice"];
};
...
onBeforeMount(async () => {
  ...
  if (cartStorage) {
    ...
    // Loop through each item in the cart and dispatch it
...
onMounted(() => {
  // Set initial visibility when the component is mounted
  isVisible.value = store.getters["cart/isCartVisible"];
});

watch(
  () => store.getters["cart/isCartVisible"],
  (newValue) => {
    // Update visibility when isCartVisible changes
