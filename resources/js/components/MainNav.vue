          ...
          <div class="flex h-16 items-center">
            ...
            <div class="ml-auto flex items-center">
              <div
                ...
                v-if="isAuthenticated === true || isAuthenticated === null"
              >
                <a
                  href="/sign-in"
...
watchEffect(() => {
  // Watch for changes in the cart length and update the cartLength variable
  cartLength.value = store.getters["cart/cartLength"];
});
</script>
